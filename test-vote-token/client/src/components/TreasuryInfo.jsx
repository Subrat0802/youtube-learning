  ...
  const fetchTreasuryInfo = async () => {
    ...
    try {
      ...
      try{
        ...
        console.log("TREASURY_ACCOUNT_DATA",treasuryAccountData)
        setTreasuryInfo({
          treasuryConfig: treasuryConfigPda.toBase58(),
          solVault: solVaultPda.toBase58(), // ✅ FIX
      ...
      // console.log("Treasury Data", treasuryAccountData);
    } catch (err) {
        ...
        <div className="treasury-details">
          <div
            className={`status-badge ${
              treasuryInfo.isInitialized ? "registered" : "not-registered"
            }`}
